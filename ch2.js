...
<div className="highlight"><pre><code></code> node --version
*v7.4.0
npm --version
*v4.0.5
</pre></div>
...
<div className="highlight"><pre><code></code> npm install -g &lt;package&gt;
</pre></div>
...
<div className="highlight"><pre><code></code> npm install &lt;package&gt;
</pre></div>
...
<div className="highlight"><pre><code></code> npm install react
</pre></div>
...
<div className="highlight"><pre><code></code> npm install --save &lt;package&gt;
</pre></div>
...
<div className="highlight"><pre><code></code> npm init -y
</pre></div>
...
<div className="highlight"><pre><code></code><code className="o">&lt;</code><code className="nx">script</code> <code className="nx">src</code><code className="o">=</code><code className="s2">"https://unpkg.com/react@15/dist/react.js"</code><code className="o">&gt;&lt;</code><code className="err">/script&gt;</code>
<code className="o">&lt;</code><code className="nx">script</code> <code className="nx">src</code><code className="o">=</code><code className="s2">"https://unpkg.com/react-dom@15/dist/react-dom.js"</code><code className="o">&gt;&lt;</code><code className="err">/script&gt;</code>
</pre></div>
...
<p className="it">Cuando tu aplicación tiene un <em>package.json</em> de archivos, podes instalar <em>React</em> y <em>React-dom</em> desde la línea de comandos. El requisito es que la carpeta se inicializa como proyecto NPM con un archivo <em>package.json</em>. Podes instalar varios paquetes de node en una línea con npm.</p>
...
<div className="highlight"><pre><code></code> npm install --save react react-dom
</pre></div>
...
<div className="highlight"><pre><code></code> npm install -g create-react-app
</pre></div>
...
<div className="highlight"><pre><code></code> create-react-app --version
</pre></div>
...
<div className="highlight"><pre><code></code> create-react-app hackernews<br></br>
cd hackernews
</pre></div>
...
<div className="highlight"><pre><code></code> hackernews/<br></br>
  README.md<br></br>
  node_modules/<br></br>
  package.json<br></br>
  .gitignore<br></br>
...
<p className="it">La atención se centra principalmente en el archivo <em>src/App.js</em> para implementar componentes React. Será utilizado para implementar tu aplicación , pero más tarde es posible que desees dividir tus componentes en varios archivos.</p>
...
<div className="highlight"><pre><code></code>// Runs the application in http://localhost:3000<br></br>
npm start<br></br>
<br></br>
...
<code className="kr">import</code> <code className="nx">logo</code> <code className="nx">from</code> <code className="s1">'./logo.svg'</code><code className="p">;</code><br></br>
<code className="kr">import</code> <code className="s1">'./App.css'</code><code className="p">;</code><br></br>
<br></br>
<code className="kr">class</code> <code className="nx">App</code> <code className="kr">extends</code> <code className="nx">Component</code> <code className="p">&#123;</code><br></br>
  <code className="nx">render</code><code className="p">()</code> <code className="p">&#123;</code><br></br>
    <code className="k">return</code> <code className="p">(</code><br></br>
      <code className="o">&lt;</code><code className="nx">div</code> <code className="nx">className</code><code className="o">=</code><code className="s2">"App"</code><code className="o">&gt;</code><br></br>
        <code className="o">&lt;</code><code className="nx">div</code> <code className="nx">className</code><code className="o">=</code><code className="s2">"App-header"</code><code className="o">&gt;</code><br></br>
          <code className="o">&lt;</code><code className="nx">img</code> <code className="nx">src</code><code className="o">=</code><code className="p">&#123;</code><code className="nx">logo</code><code className="p">}</code> <code className="nx">className</code><code className="o">=</code><code className="s2">"App-logo"</code> <code className="nx">alt</code><code className="o">=</code><code className="s2">"logo"</code> <code className="o">/&gt;</code><br></br>
          <code className="o">&lt;</code><code className="nx">h2</code><code className="o">&gt;</code><code className="nx">Welcome</code> <code className="nx">to</code> <code className="nx">React</code><code className="o">&lt;</code><code className="err">/h2&gt;</code><br></br>
        <code className="o">&lt;</code><code className="err">/div&gt;</code><br></br>
        <code className="o">&lt;</code><code className="nx">p</code> <code className="nx">className</code><code className="o">=</code><code className="s2">"App-intro"</code><code className="o">&gt;</code><br></br>
          <code className="nx">To</code> <code className="nx">get</code> <code className="nx">started</code><code className="p">,</code> <code className="nx">edit</code> <code className="o">&lt;</code><code className="nx">code</code><code className="o">&gt;</code><code className="nx">src</code><code className="o">/</code><code className="nx">App</code><code className="p">.</code><code className="nx">js</code><code className="o">&lt;</code><code className="err">/code&gt; and save to reload.</code><br></br>
        <code className="o">&lt;</code><code className="err">/p&gt;</code><br></br>
      <code className="o">&lt;</code><code className="err">/div&gt;</code><br></br>
    <code className="p">);</code><br></br>
  <code className="p">&#125;</code><br></br>
<code className="p">&#125;</code><br></br>
<br></br>
<code className="kr">export</code> <code className="k">default</code> <code className="nx">App</code><code className="p">;</code>
</pre></div>

</figure>

<p className="it">No te dejes confundir por las declaraciones de importación/exportación y la declaración de la clase. Estas características ya están en JavaScript ES6. Vamos a volver a ello en un capítulo posterior.</p>
...
<p className="it">En el archivo que tiene un <strong>componente de clase ES6</strong> con el nombre App. Es una declaración de componentes. Básicamente después de haber declarado un componente, podes utilizarlo como elemento en toda tu aplicación . Se producirá un <strong>instancia</strong> de tu <strong>componente</strong> o en otras palabras: se crea una instancia del componente.</p>
...
<p className="it">El <strong>elemento</strong> que devuelve se especifica en el método <code>render()</code>. Los elementos son los componentes que están hechos. Es útil para entender las diferencias entre componente, instancia y elemento.</p>
...
class App extends Component &#123;<br></br>
  render() &#123;<br></br>
<code className="uil">    var helloWorld = 'Welcome to React';<br></br>
</code>    return (<br></br>
      &lt;div className="App"&gt;<br></br>
<code className="uil">        &lt;h2&gt;&#123;helloWorld}&lt;/h2&gt;<br></br>
</code>      &lt;/div&gt;<br></br>
    );<br></br>
  &#125;<br></br>
&#125;<br></br>
...
<p className="it">Además habrás notado el atributo <code>className</code>. Refleja el nivel de atributos <code>class</code> en HTML. Debido a razones técnicas, JSX tuvo que sustituir a un puñado de atributos HTML internos. Podes encontrar todos los <a href="https://facebook.github.io/react/docs/dom-elements.html">atributos HTML admitidos en la documentación React</a>. En tu camino de aprendizaje de React te encontrarás con algunos atributos más de JSX.</p>
...
<ul>
  <li className="it">definir más variables y hacerlas en tu JSX </li>
...
<div>
    <header>
      <nav>
        <Link href='./jsObjects'><a>JS</a></Link> |
